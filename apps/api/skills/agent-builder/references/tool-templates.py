...
WRITE_FILE_CHUNK_TOOL = {
    "name": "write_file_chunk",
    "description": "Write one text chunk to a file. Use overwrite for the first chunk and append for later chunks.",
    "input_schema": {
        "type": "object",
        "properties": {
            "path": {
            ...
            "content": {
                "type": "string",
                "description": "Text content chunk to write"
            },
            "mode": {
                "type": "string",
...
def run_write_file_chunk(path: str, content: str, mode: str = "append") -> str:
    """
    Write one text chunk to file, creating parent directories if needed.
...
def run_replace_in_file(path: str, old_text: str, new_text: str) -> str:
    """
...
def execute_tool(name: str, args: dict) -> str:
    ...
    if name == "write_file_chunk":
        return run_write_file_chunk(args["path"], args["content"], args.get("mode", "append"))
    if name == "replace_in_file":
        return run_replace_in_file(args["path"], args["old_text"], args["new_text"])
    # Add more tools here...
