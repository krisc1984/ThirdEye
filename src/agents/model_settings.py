...
try:
    ...
    # Older openai Python builds do not expose the typed alias yet.
    # Keep runtime compatibility by accepting plain dict payloads.
    ContextManagement: TypeAlias = dict[str, Any]
